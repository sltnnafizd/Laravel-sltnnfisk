              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      <form action="{{ route('casts.delete', $value->id) }}" method="post">
                  <a href="{{ route('casts.edit', $value->id) }}" class="btn btn-sm btn-info">
                    Detail
                  </a>
                    Edit
                  </a>
                ...
                <a href="{{ route('casts.create') }}" class="btn btn-primary">Tambah Data</a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
